...
import { FaMicrophoneAlt, FaDrum, FaGuitar, FaMixcloud, FaMusic, FaBars } from "react-icons/fa";
              ...
              <ul className="absolute top-full right-0 hidden group-hover:block min-w-[200px] bg-gray-900/90 backdrop-blur-lg rounded-xl p-2 border border-gray-700/50 shadow-2xl">
                {[
                  ...
                  <li key={index}>
                    <Link
                      href={item.href}
                      className="block px-4 py-3 text-gray-300 hover:text-green-300 rounded-lg hover:bg-gray-800/50 transition-colors duration-300"
                    >
                      {item.name}
                    </Link>
                  </li>
