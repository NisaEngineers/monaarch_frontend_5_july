...
const testimonials = [
  {
    ...
    content:
      "Monaarch's vocal remover is a lifesaver for my DIY projects. It isolates vocals so cleanly that it feels like magic. My mixes have never sounded better!",
    categories: [1, 3, 5],
  },
  {
    ...
    content:
      "I've used several audio tools, but Monaarch stands out. Its advanced splitting capabilities allow me to work with individual instrument tracks effortlessly. It's a game-changer for my production process.",
    categories: [1, 2, 4],
  },
  {
    ...
    content:
      "Mixing and mastering used to take up so much of my time, but not anymore. Monaarch's AI-powered tools streamline the process, allowing me to focus on creativity instead of technicalities.",
    categories: [1, 2, 5],
  },
  {
    ...
    content:
      "The chord extraction feature of Monaarch is fantastic for our music classes. It helps students understand the harmonic structure of their favorite songs in a practical and interactive way.",
    categories: [1, 4],
  },
  {
    ...
    company: "Podcaster",
    content:
      "As a podcaster, having high-quality audio is crucial. Monaarch's mixing and mastering tools ensure that my episodes sound professional and polished. I couldn't do without it!",
    categories: [1, 3, 5],
  },
  {
    ...
    content:
      "Monaarch is incredibly versatile. Whether I'm splitting tracks for fun or extracting chords for learning, the platform never disappoints. It's my go-to for all things audio.",
    categories: [1, 3],
  },
  {
    ...
    company: "DJ",
    content:
      "I was blown away by how easily I could create high-quality mixes using Monaarch. The vocal remover and splitting services are top-notch. My sets have never sounded this good!",
    categories: [1, 2, 5],
  },
  {
    ...
    content:
      "Monaarch's intuitive interface makes it easy to create and edit audio content. The platform's minimalist design and powerful features help me stay organized and efficient.",
    categories: [1, 4],
  },
  {
    ...
    content:
      "I'm not a tech expert, but Monaarch's user-friendly tools made it easy for me to create professional-sounding karaoke tracks. The vocal remover exceeded my expectations!",
    categories: [1, 2],
  },
];
...
export default function Testimonials() {
  ...
  <p className="text-lg text-indigo-200/80">
    Discover how Monaarch is revolutionizing audio editing for musicians and creators worldwide.
  </p>
</div>
